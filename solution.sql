...
--SELECT username, city FROM syntax_practice WHERE city = 'chicago';
...
--VALUES ('corey', 'spooner', 1, 1, 100000000);
...
--DELETE FROM syntax_practice WHERE city = 'miami' OR city = 'pheonix' OR transactions_completed > 5;
